...
PLACE_CORRECTIONS = {
    ...
    "平和島": {"展示": 0.2, "直線": 0.3, "回り足": 0.3, "一周": 0.2, "サンプル数": 1150, "イン逃げ率": 45.8}, # 追加
    "多摩川": {"展示": 0.3, "直線": 0.2, "回り足": 0.2, "一周": 0.3, "サンプル数": 1200, "イン逃げ率": 53.4}, # 追加
    "浜名湖": {"展示": 0.3, "直線": 0.3, "回り足": 0.2, "一周": 0.2, "サンプル数": 1300, "イン逃げ率": 51.5}, # 追加
    "住之江": {"展示": 0.4, "直線": 0.1, "回り足": 0.3, "一周": 0.2, "サンプル数": 1560, "イン逃げ率": 58.9},
    "尼崎": {"展示": 0.3, "直線": 0.2, "回り足": 0.3, "一周": 0.2, "サンプル数": 1400, "イン逃げ率": 56.2}, # 追加
    "徳山": {"展示": 0.4, "直線": 0.1, "回り足": 0.2, "一周": 0.3, "サンプル数": 1600, "イン逃げ率": 64.1}, # 追加
